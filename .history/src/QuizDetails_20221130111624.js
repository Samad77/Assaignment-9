...
let QuizOption = ({option, quiz}) => {
    ...
    const [isCheacked, setIscheacked] = useState(true)
    ...
    return(
        ...
        <div className='w-10/12 mx-auto my-5'>
            ...
            <label className='text-black'><input type="checkbox" onChange={handleChange} value={option} className='my-5 mr-2' checked={isCheacked}/>{option}</label>
