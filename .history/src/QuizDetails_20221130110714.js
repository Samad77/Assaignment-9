...
let QuizOption = ({option, quiz}) => {
    ...
    return(
        ...
        <button className='bg-slate-100 mt-5 w-full rounded-xl' onClick={showCorrectAns}>
            ...
            {/* <p className='text-red-700 my-4 '>{option}</p> */}
            <label className='text-black'><input type="checkbox" onChange={handleChange} value={option} className='my-5 mr-2'/>{option}</label>
