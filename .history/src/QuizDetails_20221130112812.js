...
let QuizOption = ({option, quiz}) => {
    ...
    return(
        ...
        <div className='w-10/12 mx-auto my-5'>
            ...
            <label className='text-black'><input type="radio" onChange={handleChange} value={option} className='my-5 mr-2' checked={isCheacked}/>{option}</label>
